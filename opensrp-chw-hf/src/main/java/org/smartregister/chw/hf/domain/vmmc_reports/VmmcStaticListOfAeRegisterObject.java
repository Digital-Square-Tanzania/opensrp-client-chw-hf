...
public class VmmcStaticListOfAeRegisterObject extends ReportObject {

    private Date reportDate;
    private Date startDate;
    private Date endDate;

    public VmmcStaticListOfAeRegisterObject(Date reportDate) {
        super(reportDate, null, null);
        this.reportDate = reportDate;
    }

    public VmmcStaticListOfAeRegisterObject(Date reportDate, Date startDate, Date endDate) {
    ...
    public JSONObject getIndicatorData() throws JSONException {
        ...
        List<Map<String, String>> getVmmcRegisterList = ReportDao.getVmmcStaticListOfAeRegister(reportDate, startDate, endDate);
        int i = 0;

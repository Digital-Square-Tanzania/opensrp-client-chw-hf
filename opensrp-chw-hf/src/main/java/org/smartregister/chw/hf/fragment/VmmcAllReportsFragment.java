...
public class VmmcAllReportsFragment extends Fragment implements View.OnClickListener{
    ...
    public VmmcAllReportsFragment(){

    }

    public VmmcAllReportsFragment(String reportPeriod, String startDate, String endDate){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_vmmc_all_reports_tab, container, false);
        setupViews(view);
        return view;
    }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.vmmc_report) {
            VmmcReportsViewActivity.startMe(getActivity(),  Constants.ReportConstants.ReportPaths.VMMC_REPORT_PATH,R.string.vmmc_reports_subtitle, reportPeriod, startDate, endDate);
        }
        if (id == R.id.vmmc_register_report) {
            VmmcReportsViewActivity.startMe(getActivity(),  Constants.ReportConstants.ReportPaths.VMMC_REGISTER_PATH,R.string.vmmc_register_subtitle, reportPeriod, startDate, endDate);
        }

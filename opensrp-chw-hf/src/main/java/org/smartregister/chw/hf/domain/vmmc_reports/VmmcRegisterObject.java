...
public class VmmcRegisterObject extends ReportObject {

    private Date reportDate;

    public VmmcRegisterObject(Date reportDate) {
        super(reportDate);
    ...
    public JSONObject getIndicatorData() throws JSONException {
        ...
        List<Map<String, String>> getVmmcRegisterList = ReportDao.getVmmcRegister(reportDate);

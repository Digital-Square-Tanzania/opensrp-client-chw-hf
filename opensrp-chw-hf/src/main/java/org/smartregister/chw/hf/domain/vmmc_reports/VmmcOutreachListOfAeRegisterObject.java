...
public class VmmcOutreachListOfAeRegisterObject extends ReportObject {

    private Date reportDate;
    private Date startDate;
    private Date endDate;

    public VmmcOutreachListOfAeRegisterObject(Date reportDate) {
        super(reportDate, null, null);
        this.reportDate = reportDate;
    }

    public VmmcOutreachListOfAeRegisterObject(Date reportDate, Date startDate, Date endDate) {
    ...
    public JSONObject getIndicatorData() throws JSONException {
        ...
        List<Map<String, String>> getVmmcRegisterList = ReportDao.getVmmcOutreachListOfAeRegister(reportDate, startDate, endDate);
        int i = 0;

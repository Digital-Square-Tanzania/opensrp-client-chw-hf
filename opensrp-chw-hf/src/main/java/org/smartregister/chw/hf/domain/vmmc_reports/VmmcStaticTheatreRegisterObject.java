...
public class VmmcStaticTheatreRegisterObject extends ReportObject {

    private Date reportDate;
    private Date startDate;
    private Date endDate;

    public VmmcStaticTheatreRegisterObject(Date reportDate) {
        super(reportDate);
        this.reportDate = reportDate;
    }

    public VmmcStaticTheatreRegisterObject(Date reportDate, Date startDate, Date endDate) {
    ...
    public JSONObject getIndicatorData() throws JSONException {
        ...
        List<Map<String, String>> getVmmcRegisterList = ReportDao.getVmmcStaticTheatreRegister(reportDate,startDate,endDate);

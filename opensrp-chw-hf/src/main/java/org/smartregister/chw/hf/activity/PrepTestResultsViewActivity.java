...
import org.smartregister.chw.hf.fragment.PrepHepatitisTestResultsFragment;
import org.smartregister.chw.hf.utils.PmtctVisitUtils;
import org.smartregister.chw.kvp.activity.BaseTestResultsViewActivity;
...
public class PrepTestResultsViewActivity extends BaseTestResultsViewActivity implements View.OnClickListener {
    ...
    public static void startResultsForm(Context context, String jsonString, String baseEntityId, String parentFormSubmissionId) {
        Intent intent = new Intent(context, PrepTestResultsViewActivity.class);
    ...
    public BaseTestResultsFragment getBaseFragment() {
        return PrepHepatitisTestResultsFragment.newInstance(baseEntityId);
    }

    @Override
    protected void onCreation() {
        String jsonString = getIntent().getStringExtra(Constants.ACTIVITY_PAYLOAD.KVP_FORM_NAME);
